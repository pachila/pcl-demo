...
var minlengthDirective = function() {
  ...
  //bindJQuery方法是检查是否引用jquery，没有的话jqlite就用本身自带的，否则切换到jquery中去
  bindJQuery();

  // publishExternalAPI这个方法是绑定一些公共的方法到angular下面,
  // 这些是可以在网站中访问到的,像forEach,copy等公共方法，还有一个重要的任务就是初始化angular核心的模块
